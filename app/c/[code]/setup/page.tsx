...
export default function SetupPage() {
  ...
  const [teeId, setTeeId] = useState(comp.tees[0]?.id ?? "");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setPlayerId(data.player.id, comp.joinCode);
      router.push(`/c/${comp.joinCode}/play`);
    } catch {
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium mb-1" htmlFor="prediction">
                ...
                <span className="text-gray-400 dark:text-gray-500">(just for fun)</span>
              </label>
              <input
                id="prediction"
                type="text"
